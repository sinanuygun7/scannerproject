...
class ScannerApp:
    def __init__(self, root):
        ...
        # Cihazları listele
        self.device_listbox = tk.Listbox(self.root, selectmode=tk.MULTIPLE, height=10, bg="#333333", fg="white", selectbackground="#555555", selectforeground="white")
        ...
        # Dosya adı girişi
        label_file_name = ttk.Label(self.root, text="Dosya Adı:", background="#2E2E2E", foreground="white")
        ...
        # Dosya sahibi girişi
        label_file_owner = ttk.Label(self.root, text="Dosya Sahibi:", background="#2E2E2E", foreground="white")
        ...
        # Dosya konumu butonu
        label_file_location = ttk.Label(self.root, text="Dosya Konumu:", background="#2E2E2E", foreground="white")
        ...
        self.create_button = ttk.Button(self.root, text="Dosya Oluştur", command=self.create_file, style="TButton")
        self.create_button.grid(row=6, column=0, columnspan=2, pady=20)

        # Durum mesajı
        self.status_label = ttk.Label(self.root, text="", foreground="red", background="#2E2E2E")
    ...
    def set_dark_mode(self):
        ...
        style = ttk.Style()
        style.configure("TButton", background="#FFD700", foreground="black", padding=6)  # Altın rengi buton, siyah yazı
        style.configure("TLabel", background="#2E2E2E", foreground="white")
        style.configure("TEntry", fieldbackground="#555555", foreground="white", padding=6)
